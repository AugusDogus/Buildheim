...
The banner and package icon use hammer artwork inherited from PlanBuild.
The SVG sources embed the original image and use a flat forest-green background.
