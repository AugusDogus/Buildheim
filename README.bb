...
Install BepInEx and Jötunn on your client. Press End in a world to open the planner. Blueprints live in BepInEx/config/PlanBuild/blueprints. Capture nearby player-built pieces or load a file, adjust its position, then close the planner and equip your hammer. With Assist hammer enabled, aim at missing hologram pieces near a surface and click. The recipe and pose are selected automatically. You must carry the materials; Valheim validates placement and consumes resources normally. Completed pieces disappear from the guide.
