...
Install BepInEx and Jötunn on your client. Press End in a world to open the planner. Blueprints live in BepInEx/config/PlanBuild/blueprints. Capture nearby player-built pieces or load a file, adjust its position, then close the planner to build normally.
